...
const Button = React.forwardRef(({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-accent-cyan to-accent-purple text-white shadow-lg hover:shadow-accent-cyan/20 border border-transparent',
    secondary: 'glass-panel text-white hover:bg-white/10 border border-white/10 hover:border-accent-cyan/30',
